...
@section('content')
    ...
    <div class="container">
        <div class="d-flex gap-5">  
            ...
            <div class="cold-md-8">
                <h2 class="text-center mt-5" >Update infos</h2>
            </div>
        </div>
        <form class="form mt-5" method="post"  enctype="multipart/form-data">        
            ...
            <div class="form-group my-3 mx-auto col-md-6">
                <div class="d-flex gap-2">
                    ...
                    <input type="file" name="profile" class="form-control" value="{{$employe['profile']}}"   placeholder="profile">
                </div>
            ...
            <div class="form-group my-3 mx-auto col-md-6">
                ...
                <path d="M2.873 11.297V4.142H1.699L0 5.379v1.137l1.64-1.18h.06v5.961h1.174Zm3.213-5.09v-.063c0-.618.44-1.169 1.196-1.169.676 0 1.174.44 1.174 1.106 0 .624-.42 1.101-.807 1.526L4.99 10.553v.744h4.78v-.99H6.643v-.069L8.41 8.252c.65-.724 1.237-1.332 1.237-2.27C9.646 4.849 8.723 4 7.308 4c-1.573 0-2.36 1.064-2.36 2.15v.057h1.138Zm6.559 1.883h.786c.823 0 1.374.481 1.379 1.179.01.707-.55 1.216-1.421 1.21-.77-.005-1.326-.419-1.379-.953h-1.095c.042 1.053.938 1.918 2.464 1.918 1.478 0 2.642-.839 2.62-2.144-.02-1.143-.922-1.651-1.551-1.714v-.063c.535-.09 1.347-.66 1.326-1.678-.026-1.053-.933-1.855-2.359-1.845-1.5.005-2.317.88-2.348 1.898h1.116c.032-.498.498-.944 1.206-.944.703 0 1.206.435 1.206 1.07.005.64-.504 1.106-1.2 1.106h-.75v.96Z"/>
                    ...
                    <input type="text" name="code" class="form-control"
                     value="{{ $employe['code'] }}"   placeholder="Code">
                </div>
            ...
            <div class="form-group my-3 mx-auto col-md-6">
                ...
                <input type="text" name="Noun" class="form-control" value="{{ $employe->Noun }}"  placeholder="Noun">
                </div>
            ...
            <div class="form-group my-3 mx-auto col-md-6">
                <div class="d-flex gap-2">
                    ...
                    <input type="text" name="Address" class="form-control" value="{{ $employe->Address }}"  placeholder="Address">
                </div>
            ...
            <div class="form-group my-3 mx-auto col-md-6">
                ...
                <path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z"/>
                    ...
                    <input type="number" name="phone" class="form-control" value="{{ $employe->phone }}"  placeholder="phone">
                </div>
